from mjlab.tasks.cartpole.cartpole_env_cfg import (
  ...
  cartpole_reppo_runner_cfg,
  cartpole_sac_runner_cfg,
...
register_mjlab_task(
  task_id="Mjlab-Cartpole-Balance-REPPO",
  env_cfg=cartpole_balance_env_cfg(),
  play_env_cfg=cartpole_balance_env_cfg(play=True),
  rl_cfg=cartpole_reppo_runner_cfg(),
)

register_mjlab_task(
  task_id="Mjlab-Cartpole-Swingup-REPPO",
  env_cfg=cartpole_swingup_env_cfg(),
  play_env_cfg=cartpole_swingup_env_cfg(play=True),
  rl_cfg=cartpole_reppo_runner_cfg(),
)
...
register_mjlab_task(
  task_id="Mjlab-Cartpole-Swingup-SAC",
  env_cfg=cartpole_swingup_env_cfg(),
  play_env_cfg=cartpole_swingup_env_cfg(play=True),
  rl_cfg=cartpole_sac_runner_cfg(),
)
