...
class RolloutStorage:
    ...
    class Transition:
        ...
        def __init__(self) -> None:
            ...
            """Flags indicating artificial time-limit truncation (RL only)."""
    ...
    class Batch:
        ...
        def __init__(
            ...
            self.truncations: torch.Tensor | None = truncations
            """Batch of artificial time-limit truncation flags (RL only)."""
    ...
    def add_transition(self, transition: Transition) -> None:
        ...
        if self.training_type == "rl":
            ...
            if transition.truncations is not None:
                ...
                self.truncations[self.step].zero_()
        ...
        for epoch in range(num_epochs):
            for i in range(num_mini_batches):
                ...
                yield RolloutStorage.Batch(
                    ...
                    truncations=truncations[batch_idx],
                )
        ...
        for ep in range(num_epochs):
            ...
            for i in range(num_mini_batches):
                ...
                yield RolloutStorage.Batch(
                    ...
                    truncations=self.truncations[:, start:stop],
                )
